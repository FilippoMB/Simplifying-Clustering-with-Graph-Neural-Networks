Code to reproduce the results from the *Just Balance GNN* (JBGNN) model for graph clustering (and for graph pooling), presented in the paper [Simplifying Clustering with Graph Neural Networks](https://arxiv.org/abs/2207.08779).
